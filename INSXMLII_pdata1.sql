...
--EXEC SP_INS_INSXMLII
--DROP TABLE INSXMLII

--TRUNCATE TABLE INSXMLII
CREATE PROCEDURE [dbo].[SP_INS_INSXMLII]
AS
BEGIN

CREATE TABLE INSXMLII
(
...
--insert into table
INSERT INTO INSXMLII(XMLData, LoadedDateTime)
SELECT CONVERT(XML,BulkColumn) AS BulkColumn, GETDATE() 
FROM OPENROWSET(BULK 'C:\Users\v-jahsi\Desktop\10902-XML\INSXMLII.XML',SINGLE_BLOB) AS x;

--SELECT * FROM INSXMLII
